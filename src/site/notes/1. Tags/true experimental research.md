---
{"dg-publish":true,"permalink":"/1-tags/true-experimental-research/","noteIcon":""}
---
...
[[randomized posttest control group \|randomized posttest control group ]]design 
[[1. Tags/randomized pretest-posttest control group\|randomized pretest-posttest control group]] design 
randomized [[1. Tags/matched control group\|matched control group]] design 
[[1. Tags/randomized factorial design\|randomized factorial design]] (Suter. 2012, Ch. 10)
...
- is it bias to prefer this design?

True experimental designs in education combine an independent variable (a manipulation) with random assignment. They are well suited for uncovering cause-andeffect relationships when a research question focuses on testing treatment or intervention effects. **Many specific designs exist, yet they share a defining characteristic: a [[true independent variable\|true independent variable]].** (Suter, 2012, Ch. 10, pg. 12)

True experimental designs **incorporate a manipulation with random assignment to groups** (e.g., the randomized posttest control group design). The **strength of the true experimental design is highlighted by its contrast to “[[1. Tags/preexperimental design\|preexperimental design]]”  that have very little control over threatening influences**. True experimental factorial designs are especially useful, for **they yield information about main (overall) effects as well as interactive (nonadditive, “compounding”) effects**.

>[!note] related to
> [[1. Tags/randomized factorial design\|randomized factorial design]], 
>  [[2. Indexes/📚 ETEC500, Chapter 10\|📚 ETEC500, Chapter 10]]
