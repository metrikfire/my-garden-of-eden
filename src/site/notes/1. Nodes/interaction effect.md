---
{"dg-publish":true,"permalink":"/1-nodes/interaction-effect/","tags":["#research-methods"],"noteIcon":""}
---

**Definition**:
Interaction effect: An effect that occurs in [[1. Nodes/randomized factorial design\|randomized factorial design]] when the influence of one factor depends on the level or category of a second factor (e.g., a treatment affects males but not females). The key word here is depends. 
...
>[!note] related to:
> [[1. Nodes/main effect\|main effect]],  [[4. Artifacts/Intro to Research Methodologies, Ch 10\|Intro to Research Methodologies, Ch 10]]